...
const playAd = (adId: string) => {
  console.log('Play ad:', adId)
}
</script>
        ...
        <div class="flex min-w-0 gap-x-4">
          <div class="min-w-0 flex-auto">
            ...
            <div class="mt-2 flex flex-wrap gap-2 items-center" v-if="ad.probability">
              <span class="inline-flex items-center gap-1 rounded-full bg-gray-100 text-gray-700 text-xs font-medium px-2.5 py-1">
              ...
              <span class="inline-flex items-center gap-1 rounded-full bg-emerald-100 text-emerald-800 text-xs font-medium px-2.5 py-1">
