<template>
  <div class="p-6 max-w-6xl mx-auto">
    ...
    <div v-else-if="purchaseError"
      ...
      <span>{{ purchaseError.message || 'Failed to purchase item.' }}</span>
    ...
    <ul v-else role="list" class="divide-y divide-gray-100">
      <Alert v-if="purchaseFailureMessage" title="Purchase failed" :message="purchaseFailureMessage" class="mb-4"
        @dismiss="purchaseFailureMessage = null" />
...
import { useShopList, usePurchaseShopItem } from '../composables/useShop'
...
const purchaseFailureMessage = ref<string | null>(null)
